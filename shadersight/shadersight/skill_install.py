...
BEGIN = "<!-- shadersight:begin (managed by the shadersight package) -->"
END = "<!-- shadersight:end -->"
MEMORY_BLOCK = f"""{BEGIN}
- **shadersight** (`~/.claude/skills/shadersight/SKILL.md`) - review OR EDIT materials/BRDFs (energy, reciprocity) and shader node graphs (cycles, cost);
  edit = material --from-json + flags. Trigger: `/shadersight`
When a request matches that domain — creating, reviewing or EDITING an
existing file — use the installed shadersight skill before doing anything else,
